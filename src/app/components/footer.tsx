...
export default function Footer() {
  return (
    <footer className='grid grid-cols-3 :gap-6 max-w-7xl mx-auto px-4 md:px-10 md:mt-20'>
      ...
      <div className='col-span-3 md:col-span-1'>
        <div className='p-4 md:m-2 text-base'>
          <div className='flex items-center py-1'>
            <FaEnvelope /> <a className='ml-2'>nikolasmarcos@gmail.com</a>{' '}
          </div>
          <div className='flex items-center py-1'>
            <FaLinkedin />
            <a
              className='ml-2 underline decoration-transparent hover:decoration-inherit transition-all duration-300'
              href='https://www.linkedin.com/in/nikolas-mello-dev-front/'
              target='_blank'
            >
              LinkedIn
            </a>
