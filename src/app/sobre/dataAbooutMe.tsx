...
export const myData: Resume = {
  name: 'Nikolas Mello',
  about: [
    'Devido a minha grande fascinação pelo desenvolvimento Front-end, continuo aprimorando minhas habilidades com React JS e Angular na construção de aplicativos funcionais com ótima performance, design fluído e intuitivo para que os usuários tenham a melhor experiência possível.',
  ],
  experience: [
    'No início da minha carreira atuei como desenvolvedor freelancer construindo protótipos de landing pages e aplicativos no Adobe XD, e posteriormente atuei no desenvolvimento com React JS e Material UI(um dos meus frameworks favoritos).',
    ...
    'Minhas atividades cotidianas comuns são:',
    '- Desenvolvimento de novos módulos e componentes que irão consumir serviços da API, Angular forms e validações;',
    '- Desenvolvimento de serviços na API Restful conforme as regras do negócio, CRUD, emissão de PDFs, txt e csv;',
    '- Code review, Github, deploy e versionamento.',
  ],
  courses: [
    {
      id: 5,
        ...
        subItens: [
          {
            ...
            content: [
              {
                id: 'testLibAndJest1',
                description: 'Escrever testes para verificar funcionamento dos componentes;',
              },
              {
                id: 'testLibAndJest2',
                description: 'Experiência prática adicionando testes a um grande projeto React;',
              },
              {
                id: 'testLibAndJest3',
                description: 'Criação de matchers personalizados no Jest;',
              },
            ],
          },
        ],
          ...
          content: [
            {
              id: 'j1',
              description:
                'Dominio da Programação Orientada a Objetos e linguagem Java;',
            },
            {
              id: 'j2',
              description:
      ...
      subItens: [
        {
          ...
          content: [
            ...
            },
            {
              id: 'sql3',
              description:
                'Crie seu próprio banco de dados ou interaja com bancos de dados existentes.',
            },
            {
              id: 'sql4',
              description:
                'Modele dados do mundo real e gere relatórios usando SQL.',
            },
          ],
        },
      ],
  ...
  languages: [
    ...
    },
    {
      title: 'Inglês',
      level: 'Avançado',
      schools: ['Wizard (2010 - 2013)', 'KNN Idiomas (2020 - 2022)'],
    },
  ],
};
